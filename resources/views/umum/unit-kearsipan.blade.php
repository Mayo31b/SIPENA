...
@section('content')
    ...
    <!-- Table -->
     <br>
    <div class="overflow-x-auto rounded-lg border-2 border-blue-400 p-2">
    <h2 class="text-indigo-600 font-semibold mb-2">Unit Kearsipan</h2>
    <table class="w-full border-collapse text-sm">
        <thead>
            <tr class="bg-indigo-50 text-indigo-600">
                ...
                <th class="border px-3 py-2 text-left">JUMLAH PENGELOLA</th>
                <th class="border px-3 py-2 text-left">NARAHUBUNG</th>
